      ...
      <Drawer ref={(ref) => { this.drawer = ref; }} content={<Sidebar navigation={this.props.navigation} image={this.state.image} name={this.state.name} username={this.state.username}/>} >
        <Root>
          <Container>
            ...
            <Content>
              <Thumbnail large source={{uri: "http://117.53.47.77:3000/upload/" + this.state.image}} style={{alignSelf: "center", marginTop: 20, width: 150, height: 150, borderRadius: 100, borderWidth: 1, borderColor: "#eee"}} />
